...
// source: helichain/helichain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d63b3a4008a96952, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d63b3a4008a96952, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "helichain.helichain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "helichain.helichain.QueryParamsResponse")
}

func init() { proto.RegisterFile("helichain/helichain/query.proto", fileDescriptor_d63b3a4008a96952) }

var fileDescriptor_d63b3a4008a96952 = []byte{
	...
	0xff, 0xff, 0x9c, 0x17, 0x43, 0xf2, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/helichain.helichain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helichain.helichain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "helichain.helichain.Query",
	...
	Metadata: "helichain/helichain/query.proto",
}
