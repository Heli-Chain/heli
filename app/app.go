...
import (
	...
	helichainmodule "helichain/x/helichain"
	helichainmodulekeeper "helichain/x/helichain/keeper"
	helichainmoduletypes "helichain/x/helichain/types"

	autoburnmodule "helichain/x/autoburn"
	autoburnmodulekeeper "helichain/x/autoburn/keeper"
	autoburnmoduletypes "helichain/x/autoburn/types"
	...
	appparams "helichain/app/params"
	v12 "helichain/app/upgrades/v12"
	"helichain/docs"
)

const (
	AccountAddressPrefix = "heli"
	Name                 = "helichain"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		helichainmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	HelichainKeeper      helichainmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		helichainmoduletypes.StoreKey, wasmtypes.StoreKey,
	...
	*/
	...
	app.HelichainKeeper = *helichainmodulekeeper.NewKeeper(
		appCodec,
		keys[helichainmoduletypes.StoreKey],
		keys[helichainmoduletypes.MemStoreKey],
		app.GetSubspace(helichainmoduletypes.ModuleName),
	)
	helichainModule := helichainmodule.NewAppModule(appCodec, app.HelichainKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		helichainmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(helichainmoduletypes.ModuleName)
